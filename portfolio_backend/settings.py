...
ALLOWED_HOSTS = ["127.0.0.1", "localhost", "127.0.0.1:8080", "192.168.1.6" , "zkzk.softzm.cloud"]
...
CORS_ALLOW_CREDENTIALS = (
    True  # Allow cookies to be sent with the request (if your frontend requires it)
)
...
STATICFILES_DIRS = [
    os.path.join(
        BASE_DIR, "front-vue", "dist", "static", "css"
    ),  # Path to your CSS directory
    os.path.join(
        BASE_DIR, "front-vue", "dist", "static" "js"
    ),  # Path to your JS directory
